package com.ameliant.tools.kafka.perftool;
 ...
 * object graph representing the test profile ({@link com.ameliant.tools.kafka.perftool.config.TestProfileDefinition}).
 *
 * The test profile is then executed by a {@link com.ameliant.tools.kafka.perftool.drivers.TestProfileRunner},
